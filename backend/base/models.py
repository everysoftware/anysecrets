...
from backend.base.types import UUID, naive_utc, uuid
...
class BaseOrm(DeclarativeBase):
    ...
    def merge_model(self, model: BaseModel, **kwargs: Any) -> Self:
        for key, value in model.model_dump(exclude_unset=True, **kwargs).items():
